...
export default function ContactDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const loadContact = useCallback(async () => {
    try {
      ...
      const response = await apiClient.get(`/contacts/${resolvedParams.id}`);
  ...
  const loadAnalytics = useCallback(async () => {
    ...
    try {
      const response = await apiClient.get(`/contacts/${contact.id}/analytics`);
  ...
  const loadIdentifiers = useCallback(async () => {
    ...
    try {
      const response = await apiClient.get(`/contacts/${contact.id}/identifiers`);
  ...
  const loadRelationships = useCallback(async () => {
    ...
    try {
      const response = await apiClient.get(`/contacts/${contact.id}/relationships`);
  ...
  const loadPreferences = useCallback(async () => {
    ...
    try {
      const response = await apiClient.get(`/contacts/${contact.id}/preferences`);
  ...
  const loadAliases = useCallback(async () => {
    ...
    try {
      const response = await apiClient.get(`/contacts/${contact.id}/aliases`);
  ...
  const loadContactReplyMode = useCallback(async () => {
    ...
    try {
      const response = await apiClient.get(`/contacts/${contact.id}/reply-mode`);
  ...
  const handleContactReplyModeChange = async (mode: ReplyMode | null) => {
    if (!contact) return;
    try {
      await apiClient.patch(`/contacts/${contact.id}/reply-mode`, { mode });
  ...
  const createIdentifier = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiClient.post(`/contacts/${contact?.id}/identifiers`, newIdentifier);
  ...
  const deleteIdentifier = async (identifierId: number) => {
    ...
    try {
      await apiClient.delete(`/contacts/${contact.id}/identifiers/${identifierId}`);
  ...
  const createRelationship = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiClient.post(`/contacts/${contact?.id}/relationships`, {
  ...
  const deleteRelationship = async (relationshipId: number) => {
    ...
    try {
      await apiClient.delete(`/contacts/${contact.id}/relationships/${relationshipId}`);
  ...
  const createPreference = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiClient.post(`/contacts/${contact?.id}/preferences`, newPreference);
  ...
  const deletePreference = async (preferenceId: number) => {
    ...
    try {
      await apiClient.delete(`/contacts/${contact.id}/preferences/${preferenceId}`);
  ...
  const createAlias = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiClient.post(`/contacts/${contact?.id}/aliases`, newAlias);
  ...
  const deleteAlias = async (aliasId: number) => {
    ...
    try {
      await apiClient.delete(`/contacts/${contact.id}/aliases/${aliasId}`);
