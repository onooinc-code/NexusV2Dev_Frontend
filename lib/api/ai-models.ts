...
export const aiProvidersApi = {
  list: () =>
    apiClient.get<{ success: boolean; data: AiProvider[] }>('/ai/providers'),

  get: (id: string) =>
    apiClient.get<{ success: boolean; data: AiProvider }>(`/ai/providers/${id}`),

  create: (data: Partial<AiProvider> & { api_key?: string }) =>
    apiClient.post<{ success: boolean; data: AiProvider; message: string }>('/ai/providers', data),

  update: (id: string, data: Partial<AiProvider> & { api_key?: string }) =>
    apiClient.put<{ success: boolean; data: AiProvider; message: string }>(`/ai/providers/${id}`, data),

  delete: (id: string) =>
    apiClient.delete<{ success: boolean; message: string }>(`/ai/providers/${id}`),
...
export const aiModelsApi = {
  list: (params?: Record<string, string>) =>
    apiClient.get<{ data: AiModel[] }>('/ai-models', { params }),

  create: (data: Partial<AiModel>) =>
    apiClient.post<{ data: AiModel }>('/ai-models', data),
  ...
  delete: (id: string) => apiClient.delete(`/ai-models/${id}`),
};
...
export const intentRoutingApi = {
  ...
  updateRoute: (data: Partial<IntentRoute>) =>
    apiClient.put<{ success: boolean; data: IntentRoute }>('/ai/intents/routing', data),
};
...
export const aiCostApi = {
  getForecast: () =>
    apiClient.get<{ success: boolean; data: CostForecast }>('/ai/cost/forecast'),

  setBudget: (monthlyLimit: number, workspaceId?: string) =>
    apiClient.post<{ success: boolean; message: string }>('/ai/cost/budget', {
...
export const aiAuditApi = {
  list: (params?: { event_type?: string; status?: string; limit?: number }) =>
    apiClient.get<{ success: boolean; data: AiAuditEntry[] }>('/ai/audit-trail', { params }),
};
...
export const ecaRulesApi = {
  list: () => apiClient.get<{ data: EcaRule[] }>('/proactive/rules'),
  create: (data: Partial<EcaRule>) =>
    apiClient.post<{ success: boolean; data: EcaRule }>('/proactive/rules', data),
  toggle: (id: number) =>
    apiClient.patch<{ success: boolean }>(`/proactive/rules/${id}/toggle`),
  delete: (id: number) => apiClient.delete(`/proactive/rules/${id}`),
};
...
export const proactiveTriggersApi = {
  list: () => apiClient.get<{ data: ProactiveTrigger[] }>('/proactive/triggers'),
};
...
export const autonomousLogsApi = {
  list: () => apiClient.get<{ data: AutonomousLog[] }>('/proactive/logs'),
};
